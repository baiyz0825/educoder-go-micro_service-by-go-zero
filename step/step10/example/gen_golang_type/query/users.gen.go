...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.UserName = field.NewString(tableName, "name")
...
func (u *user) updateTableName(table string) *user {
	...
	u.UserName = field.NewString(table, "name")
...
// where(id=@id)
func (u userDo) FindByID(id int64) (result model.User, err error) {
...
func (u userDo) FindByUserName(userName string) (result []model.User, err error) {
	var params []interface{}
...
//
// where id=@id
func (u userDo) UpdateUserName(passwd string, id int) (err error) {
	var params []interface{}
	...
	if passwd != "" {
		params = append(params, passwd)
		setSQL0.WriteString("password=? ")
	}
