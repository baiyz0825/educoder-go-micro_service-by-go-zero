...
func TestGenModel(t *testing.T) {
	...
	const MysqlConfig = "username:passwd@tcp(192.168.0.12:3306)/school_order?charset=utf8mb4&parseTime=True&loc=Local"
	...
	// 创建模型的结构体
	Order := g.GenerateModelAs("order", "Order")
	UserEarn := g.GenerateModelAs("user_earn", "UserEarn")
