...
func GetClassificationDataByPagesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchClassificationSubDataReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := classification.NewGetClassificationDataByPagesLogic(r.Context(), svcCtx)
		resp, err := l.GetClassificationDataByPages(&req)
