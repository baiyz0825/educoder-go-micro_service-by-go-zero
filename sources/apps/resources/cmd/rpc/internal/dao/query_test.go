...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		qCtx.Classification.UnderlyingDB().Statement.Context,
		qCtx.Count.UnderlyingDB().Statement.Context,
		qCtx.File.UnderlyingDB().Statement.Context,
		qCtx.OnlineText.UnderlyingDB().Statement.Context,
		qCtx.ResComment.UnderlyingDB().Statement.Context,
	} {
